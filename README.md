...
```javascript
resultsFactory = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ztest-two-sample-results-factory@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var resultsFactory = require( 'path/to/vendor/umd/stats-base-ztest-two-sample-results-factory/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ztest-two-sample-results-factory@umd/browser.js"></script>
```
